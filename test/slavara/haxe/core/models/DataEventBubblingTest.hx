...
class DataEventBubblingTest {
	...
	@AsyncTest
	public function testDispatchEventBubbling(factory:AsyncFactory) {
		...
		container0.addEventListener(DataBaseEvent.ADDED, function(event:DataBaseEvent) resultHandler(event.target));
